# Index of Epics (EPICS.md)

| ID | Epic | Status | Description |
| :--- | :--- | :--- | :--- |
| **EP-01** | [Core Foundation & Infrastructure](epics/foundation/FEATURE.md) | ✅ Done | Repository setup, database (PostgreSQL), and agent infrastructure (LangGraph). |
| **EP-02** | [Command Center (Web Dashboard)](epics/command-center/FEATURE.md) | 🔄 In Progress | Central React interface, authentication, and global state with Zustand. |
| **EP-03** | [Smart Home Module (Multimodal Canvas)](epics/smart-home/FEATURE.md) | 📋 Backlog | Floor plan viewer and AI for IoT sensor positioning. |
| **EP-04** | [DevOps & ClinicCare Integration](epics/devops/FEATURE.md) | 📋 Backlog | Connectivity via MCP with VS Code and PR monitoring. |
